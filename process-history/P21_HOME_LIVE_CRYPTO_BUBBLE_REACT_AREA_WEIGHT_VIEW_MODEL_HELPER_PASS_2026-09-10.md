# P21 Home Live Crypto Bubble React Area-Weight View Model — Helper PASS

Date: 2026-09-10
Status: NON-CANONICAL HELPER FULL SUCCESS; Gate352 remains canonical GOLDEN until a newer full `Kairos Controlled Roadmap Gate` PASS is independently verified.

## Canonical base

- Latest verified canonical GOLDEN: Gate352 / run `34470528673`, job `102849110869`, head `2aa5cfce054ceb272ca15db4340eb19ea127c491`.
- Exact Gate352 candidate: `KAIROS_HOME_DASHBOARD_LIVE_CRYPTO_BUBBLE_AREA_WEIGHT_PROJECTION_FOUNDATION_CANDIDATE_2026-09-10.zip`.
- Size: `1636871` bytes.
- SHA-256: `f899195a8f61c2a817e1c2f4b2d02cf20ec662df8a9fc81631a6f74d98aea1fc`.
- Root: exactly `kairos_p76/`.

## Responsibility proved

This slice is a pure app-level Home Live Crypto Bubble React area-weight view-model projection below visible rendering.

Required behavior:
- preserve the exact Gate351 runtime-state reference;
- when `latestObservation` is null, expose a null area-weight projection;
- otherwise pass only the exact `latestObservation.presentationStateProjection` into the released Gate352 area-weight projector exactly once;
- expose the Gate352 projection separately from lifecycle/error state, so later acquisition/bootstrap errors do not erase the last authoritative observation evidence.

Explicit non-scope:
- provider acquisition/retry/clocks;
- universe, stablecoin, ranking, Top-N, movement, or freshness policy/reclassification;
- duplicated Decimal arithmetic;
- pixel radius, square-root/min-max radius policy;
- CSS/theme/palette, geometry/collision/layout, DOM or visible React rendering;
- persistence, Your Trades, journal, chart, navigation, or transitions.

## Controlled helper provenance

- Controlled payload main commit: `a89c7739e45e382f8a64d385247b60829f039345`.
- Payload path: `.github/kairos-helper-payloads/home-bubble-react-area-weight-view-model.patch`.
- Patch size: `17248` bytes.
- Patch SHA-256: `cfc8a441e372de7ba42f408911b2cc3176f5ca1bf135a2beaa61ce5eb53635ee`.
- Patch Git blob: `082887f79cc92b6bc969f5862a2ebd2f629cfb30`.
- Helper trigger main commit: `42bd9b53c6c502a3e798c7b309cdd3d6e7f40ef9`.
- Workflow: `Kairos Home Dashboard Live Crypto Bubble React Area Weight View Model Reconstruction`.
- Workflow path: `.github/workflows/home-dashboard-live-crypto-bubble-react-area-weight-view-model-reconstruct.yml`.
- Helper run: `34472216244`.
- Helper job: `102854516566`.
