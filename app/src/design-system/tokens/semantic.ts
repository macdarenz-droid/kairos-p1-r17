...
export const semanticTokens = Object.freeze({
  background: Object.freeze({ base: role('background-base'), depth: role('background-depth'), overlay: role('background-overlay'), gradient: role('background-gradient') }),
  surface: Object.freeze({ card: role('surface-card'), raised: role('surface-raised'), input: role('surface-input'), modal: role('surface-modal'), gradient: role('surface-gradient'), field: role('field-gradient') }),
  border: Object.freeze({ default: role('border-default'), subtle: role('border-subtle'), active: role('border-active'), hairline: role('border-hairline'), strong: role('border-strong') }),
  ...
  accent: Object.freeze({ primary: role('accent-primary'), secondary: role('accent-secondary'), soft: role('accent-soft'), glow: role('accent-glow'), ink: role('accent-ink') }),
