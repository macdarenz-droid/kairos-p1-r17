...
const kairosDepthTokens: ThemeTokenMap = {
  ...
  '--kairos-background-gradient': 'radial-gradient(circle at top, #131a2e, transparent 34rem), linear-gradient(180deg, #0b0d14, #0b0d14)',
  '--kairos-surface-gradient': 'linear-gradient(180deg, #0d1420, #0d1420)', '--kairos-field-gradient': 'linear-gradient(180deg, #131a2e, #0b0d14)',  '--kairos-bubble-art-filter': 'none', '--kairos-bubble-art-opacity': '1', '--kairos-bubble-glass': 'none', '--kairos-bubble-border': 'transparent', '--kairos-bubble-ring-up': 'transparent', '--kairos-bubble-ring-down': 'transparent', '--kairos-bubble-shadow': 'none', '--kairos-bubble-fallback-opacity': '.8',
};
