...
export function ProfileRoute({ db = kairosDatabase, now = wallClock, downloads, readBackupFile = readFileText, durability = releasedDurability }: ProfileRouteProps) {
  ...
  async function handleExport(): Promise<void> {
    ...
    setExportState({ kind: 'done', file: result.file, skippedCount: result.skipped.savedAnalyses + result.skipped.savedTimeAssistedSnapshots + result.skipped.tradeDiscipline + result.skipped.exchangeRates + result.skipped.economicEvents });
