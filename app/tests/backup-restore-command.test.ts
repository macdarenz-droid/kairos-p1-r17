...
describe('P28.2 backup restore command', () => {
  it('prepares a restore: preview of the incoming backup, a downloadable pre-restore copy, nothing written', async () => {
    ...
    expect(result.restore.preview).toMatchObject({ formatVersion: 9, databaseSchemaVersion: 10, exportedAt: '2026-09-17T08:00:00.000Z', metadataRecords: 1, savedAnalysisRecords: 1, totalRecords: 2 });
