...
## Next safe action
P21.1 is canonical GOLDEN and P21 is OPEN. Search controlling handoff/current user-source history for an authoritative P21 Bubble Map product requirement or exact Home-dashboard data contract. If one is found, trace it against P21.1 GOLDEN and existing P11/P12/P15/P16 owners and prove exactly one smallest dependency-safe P21.2 responsibility plus explicit non-scope. If no controlling source proves one, preserve P21.1 GOLDEN and do not invent metrics, provider subscriptions, dashboard query/calculation ownership, behavioral scoring, or transition implementation merely to advance the patch number.